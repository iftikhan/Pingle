...
public interface AWSECommerceServicePortType {
     ...
     * @param body
     * @return
     *     returns BrowseNodeLookupResponse
     */
     ...
     * @param body
     * @return
     *     returns SimilarityLookupResponse
     */
