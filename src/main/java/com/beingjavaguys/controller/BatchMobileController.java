...
public class BatchMobileController {
    ...
    @RequestMapping(value = "/mobile", method = RequestMethod.POST, consumes = MediaType.ALL_VALUE)
    public
    @ResponseBody
    Status addMobile() throws Exception {
        System.out.println("Calling mobile Services");

        List<PMobile> finalList = new ArrayList<>();

        JSONObject jsonObject = null;
        String str = "http://feeds.omgeu.com/data/feed.aspx?hash=3f3e7124a6b34c42ae0c49243eb8e232" + "&page=1";
        URL url = new URL(str);
        ...
        for (int i = 1; i < 10; i++) {
            List<PMobile> list = new ArrayList<>();
...
*/
        /*for (PMobile product : fliPMobileList) {
...
*/
      /*  for (PMobile product : snapAndInfiResults) {
            dataServices.addPMobileEntity(product);
            System.out.println("tshirtcreate Product added Successfully !");
    ...
    public List<PMobile> omgMobileData(int pageNo) throws IOException, JSONException, org.json.JSONException {

        JSONObject jsonObject = null;
        String str = "http://feeds.omgeu.com/data/feed.aspx?hash=3f3e7124a6b34c42ae0c49243eb8e232" + "&page=" + pageNo;
        URL url = new URL(str);
        InputStream is = url.openStream();
        int ptr = 0;
        StringBuilder builder = new StringBuilder();
