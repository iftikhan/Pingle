...
public class WatchController {
    ...
    public
    @ResponseBody
    String getAllPWatchBrands(@PathVariable("category") String category) {
    ...
    public
    @ResponseBody
    String getAllPWatchColor(@PathVariable("category") String category) {
        System.out.println("Category is :: " + category);
        String result = "";
        try {
    ...
    String getAllSelect(@PathVariable("brand") String brand, @PathVariable("color") String color, @PathVariable("price") String price,
        ...
        try {
            List<PWatch> finalProd = dataServices.getAllWatchList(brand, color, maxPrice, minPrice, categoryItem, order);
    ...
    public
    @ResponseBody
    String getAllPWatchClothsForCat(@PathVariable("category") String category) {

        String result = "";
        try {
            List<PWatch> finalBrandlist = dataServices.getAllWatchList();
            ...
            IndexWriter w = new IndexWriter(index, config);
            for (PWatch product : finalBrandlist) {
                addDoc(w, product.getProductName(), product.getSalePrice(), product.getMerchant(), product.getProductURL(),
                        product.getMediumImage());
            }
            w.close();
    ...
    String compareProduct(@PathVariable("productName") String productName, @PathVariable("category") String category) {
        ...
        String result = "";
        try {
            List<PWatch> PWatchs = dataServices.getWatchForCatList(category);
